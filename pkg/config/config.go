...
func initConfig(config Config) {
	...
	config.BindEnvAndSetDefault("host_metadata_interval", 14400)
	// run the agent checks metadata collector every 600 seconds (10 minutes)
	config.BindEnvAndSetDefault("agent_check_metadata_interval", 600)
	// run the resources metadata collector every 300 seconds (5 minutes)
	config.BindEnvAndSetDefault("default_resources_metadata_interval", 300)
